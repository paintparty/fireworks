...
- `:only-inline-results?` option added. On a `fireworks.core/?` macro call, This will short-circuit before formatting and console printing happens (under the hood in `fireworks.core/_p` and `fireworks.core/_p2`).
